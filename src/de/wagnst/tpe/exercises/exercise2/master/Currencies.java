...
public final class Currencies {
     ...
     * US-Dollar
     */
    public static final Currency DOLLAR = new Currency("Dollar", "$", EXCHANGE_DOLLAR,
            true);
    /**
     * EURO
     */
    public static final Currency EURO = new Currency("Euro", "€", EXCHANGE_EURO, true);

    /**
     * Japanischer Yen
     */
    public static final Currency YEN = new Currency("Yen", "¥", EXCHANGE_YEN, false);

    /**
     * Rubel der russischen Föderation
     */
    public static final Currency RUBEL = new Currency("Rubel", "RUB", EXCHANGE_RUBEL,
            false);
